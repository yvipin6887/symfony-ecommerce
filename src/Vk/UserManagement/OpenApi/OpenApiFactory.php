...
namespace App\Vk\UserManagement\OpenApi;
...
class OpenApiFactory implements OpenApiFactoryInterface
{
    ...
    public function __construct(OpenApiFactoryInterface $decorated, string $checkPath = '/api/login', string $usernamePath = 'email', string $passwordPath = 'password')
    {
